    ...
    <div>
      ...
      <section className="max-w-7xl mx-auto px-4 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            { icon: '📋', title: 'Create or Join a Comp', desc: 'Set up a comp and share the invite link with your mates, family, or workmates. Or browse public comps to join.' },
            { icon: '🏈', title: 'Tip Every Game', desc: 'Before the season kicks off, tip the winner of every single match. All 198 games, locked in from day one.' },
            { icon: '🏆', title: 'Watch the Leaderboard', desc: 'Results update automatically after every round. Watch the ladder shift as the season unfolds. No effort required.' },
          ].map((step, i) => (
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { icon: '🔒', title: 'Tips Locked In', desc: 'No changing your mind mid-season. Commit to your tips and own them.' },
              { icon: '👥', title: 'Public & Private', desc: 'Run a comp with your mates or open it up for anyone to join.' },
              { icon: '📊', title: 'Live Leaderboard', desc: 'Rankings update in real-time. Track accuracy, streaks, and more.' },
              { icon: '🎯', title: 'Full Season View', desc: 'See every round, every game, every tip at a glance.' },
              { icon: '📱', title: 'Mobile Ready', desc: 'Tip from your phone, tablet, or laptop. Works everywhere.' },
              { icon: '🆓', title: 'Completely Free', desc: 'No subscriptions, no ads, no catch. Just footy tipping.' },
              { icon: '🏈', title: 'AFL Focused', desc: 'Built specifically for AFL. Every team, every round, every venue.' },
            ].map((f, i) => (
